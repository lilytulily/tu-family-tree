...
const historyStories = [
  {
    ...
    fullText: "根據文獻記載，杜家的先祖大約是在清朝乾隆年間，從福建省泉州府同安縣渡海遷徙來台灣的。杜家渡海後，最一開始是在基隆落戶，具體地點就在基隆的八斗子一帶。早期的杜家人主要是從事農漁業，在八斗子沿岸以舢舨捕魚維生，就地取材建立了典型的「咾咕厝」，後來更成為了基隆當地的大世族。",
  ...
  },
  {
    ...
    fullText: "杜父潭中太公墓誌銘：杜潭中先生，煤礦業先進，原籍福建省泉州府同安縣安仁里十六都馬銮社。祖先為抗清扶明，隨鄭延平王來台，落籍台灣台北州基隆市基隆義重町。五傳至萬有公，配王氏，子遜清光緒癸已年 [1893] 三月初二日戊時獨生。先生廿二歲，擇配台北縣新店望族高德養老先生四媛高氏昌。生平歷辦大竿林、石碇等煤礦，處事仁慈重義，有子四、女三。卒於丙戌年 [1946] 二月廿三日子時，享壽五十有四，原葬於基隆市南榮公墓，民國戊申年 [1968] 五月初五日午時遷葬于此。長郎伯英配陳氏，育子五，曰宗賢、煌、鈞錫、鎭，女一；次郎仲雄配陳氏，育子一，曰宗擎，女五；三郎叔豪配吳氏育子二，曰宗堯、鏗，女一；四郎季傑配鄭氏育子一，曰宗尚，女三。其女三，長適謝、次適鄭、三適余。諸郎均能繼父志，加倍奮發，竭力擴充礦業，已擁有調和、順和、英和、勝和、正福諸煤礦，員工逾五千。爰于竣工日誌銘，以規其哲嗣。緬懷先生積陰功、種福田，而有今日之盛，多為積善之家，必有餘慶，以厲世代焉。",
